...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Створити Повідомлення') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('tickets.new') }}">
                        @csrf

                        <div class="form-group row py-2">
                            <label for="subject" class="col-md-4 col-form-label text-md-right">{{ __('Заголовок') }}</label>
